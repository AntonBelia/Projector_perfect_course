...
calculateBtn.addEventListener("click", timeDifferenceCalculation);
...
function timeDifferenceCalculation(num1, num2, dimension = "days", calculDays = "all") {
...
function renderDataFromLocalStorage() {
  ...
  outputData.forEach((DataElement) => {
    createOutputData(DataElement);
  });
}

function createOutputData(DataElement) {
